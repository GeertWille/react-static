    ...
    return _regenerator2.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            _context.next = 6;
            return config.getSiteData({ dev: true, cliArguments: cliArguments });
...
(function () {
  ...
  reactHotLoader.register(_default, 'default', 'src/commands/start.js');
  leaveModule(module);
})();
