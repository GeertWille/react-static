          ...
          case 7:
            ...
            devServerConfig = _extends({
              ...
              before: function before(app) {
                ...
                app.get('/__react-static__/routeInfo', function () {
                        ...
                        switch (_context4.prev = _context4.next) {
                          ...
                          case 3:
                            ...
                            routes.forEach(function (route) {
                              app.get('/__react-static__/route' + encodeURI(route.path), function () {
...
(function () {
  ...
  reactHotLoader.register(webpackConfig, 'webpackConfig', 'src/webpack/index.js');
  reactHotLoader.register(buildCompiler, 'buildCompiler', 'src/webpack/index.js');
  reactHotLoader.register(startDevServer, 'startDevServer', 'src/webpack/index.js');
  reactHotLoader.register(buildProductionBundles, 'buildProductionBundles', 'src/webpack/index.js');
  leaveModule(module);
})();
