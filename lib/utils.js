...
var getConfig = exports.getConfig = function getConfig() {
  ...
  var siteRoot = config.siteRoot ? config.siteRoot.replace(/\/{0,}$/g, '') : '';
...
(function () {
  ...
  reactHotLoader.register(defaultEntry, 'defaultEntry', 'src/utils.js');
  reactHotLoader.register(ChalkColor, 'ChalkColor', 'src/utils.js');
  reactHotLoader.register(findAvailablePort, 'findAvailablePort', 'src/utils.js');
  reactHotLoader.register(getConfig, 'getConfig', 'src/utils.js');
  reactHotLoader.register(path404, 'path404', 'src/utils.js');
  reactHotLoader.register(normalizeRoutes, 'normalizeRoutes', 'src/utils.js');
  reactHotLoader.register(copyPublicFolder, 'copyPublicFolder', 'src/utils.js');
  reactHotLoader.register(createIndexFilePlaceholder, 'createIndexFilePlaceholder', 'src/utils.js');
  reactHotLoader.register(isArray, 'isArray', 'src/utils.js');
  reactHotLoader.register(isObject, 'isObject', 'src/utils.js');
  leaveModule(module);
})();
